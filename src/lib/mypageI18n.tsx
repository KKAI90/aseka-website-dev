...
const DICT: Record<string, Record<MypageLang, string>> = {
  ...
  "status.step.quit": { en: "Left the position", vi: "Đã nghỉ việc", ja: "退職" },
  ...
  "profile.visaExpiry": { en: "Visa expiry", vi: "Hạn visa", ja: "在留期限" },
  "profile.address": { en: "Address", vi: "Địa chỉ", ja: "現住所" },
  ...
  "detail.row.positionNote": { en: "Position notes", vi: "Ghi chú vị trí", ja: "ポジション備考" },
  ...
  "detail.row.visaType": { en: "Required visa status", vi: "Tình trạng visa yêu cầu", ja: "在留資格" },
