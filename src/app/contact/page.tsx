  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 2, padding: "0 72px 0 0", maxWidth: "540px", textAlign: "right" }}>
        <h1 style={{ fontFamily: "'Noto Sans JP', sans-serif", fontSize: "clamp(44px, 6.5vw, 80px)", fontWeight: 700, color: "#0C1F2E", letterSpacing: "-1px", lineHeight: 1, margin: 0, whiteSpace: "nowrap" }}>
          {t.title}
        </h1>
        ...
        <p style={{ fontFamily: "'Noto Serif JP', serif", fontSize: "17px", fontWeight: 400, color: "#1A2E3A", letterSpacing: lang === "JP" ? "5px" : "2px" }}>
          {t.subtitle}
        </p>
      </div>
    </div>
