...
export async function GET(req: NextRequest) {
  ...
  const safeSelect = {
    ...
    jlpt_exam_year: true, jlpt_exam_month: true, jlpt_exam_status: true,
    ...
    photo_url: true, id_front_url: true, id_back_url: true,
    jlpt_cert_url: true, senmonkyu_url: true, other_cert_url: true,
  ...
  try {
    ...
    const data = await prisma.candidates.create({
      data: {
        ...
        jlpt_exam_year:   body.jlpt_exam_year || null,
        jlpt_exam_month:  body.jlpt_exam_month || null,
        jlpt_exam_status: body.jlpt_exam_status || null,
        // height_cm/weight_kg are Float columns — the form sends them as strings (like
        // every other HTML input), so this must coerce or Prisma rejects the whole
        // create. Same bug class as the earlier dependents Int/String mismatch.
        ...
        jlpt_cert_url:  body.jlpt_cert_url || null,
        senmonkyu_url:  body.senmonkyu_url || null,
        other_cert_url: body.other_cert_url || null,
