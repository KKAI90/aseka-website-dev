...
const T = {
  JP: {
    ...
    heading: "TRAINING",
    subheading: "人材育成事業",
    intro: "日本での就職を支援するために、言語力向上のためのオンライン日本語教育、特定技能向けの試験対策のサービスを提供しております。",
    cards: [
      { title: "オンライン日本語教育", body: "多くのベトナム人から支持されているTHAO TOKYOオンライン日本語スクールを運営しております。THAO TOKYOでは試験対策授業というよりもむしろ、日本語での会話の重要性に重きを置いておりますので、生活と仕事の両面で活用できるような指導に注力しております。" },
  ...
  EN: {
    ...
    intro: "To support employment in Japan, we provide online Japanese language education and exam preparation services for specified skilled workers.",
    cards: [
      { title: "Online Japanese Education", body: "We operate THAO TOKYO Online Japanese School, which is highly regarded by many Vietnamese learners. Rather than focusing solely on exam preparation, THAO TOKYO places great importance on conversational Japanese, providing instruction that can be applied in both daily life and at work." },
  ...
  VN: {
    ...
    intro: "Để hỗ trợ việc làm tại Nhật Bản, chúng tôi cung cấp dịch vụ giáo dục tiếng Nhật trực tuyến nhằm nâng cao ngôn ngữ và ôn thi kỹ năng đặc định.",
    cards: [
      { title: "Giáo dục Tiếng Nhật Trực tuyến", body: "Chúng tôi vận hành Trường Tiếng Nhật Trực tuyến THAO TOKYO được nhiều người Việt Nam tin dùng. THAO TOKYO không chỉ tập trung vào luyện thi mà đặt trọng tâm vào tầm quan trọng của giao tiếp tiếng Nhật, giúp học viên ứng dụng được trong cả cuộc sống lẫn công việc." },
