...
const T = {
  JP: {
    ...
    fields: { name: "お名前 / Họ tên *", company: "会社名 / Tên công ty *", email: "メールアドレス / Email *", phone: "電話番号 / Số điện thoại", service: "ご相談内容 / Dịch vụ quan tâm", message: "メッセージ / Nội dung" },
    namePh: "山田 太郎 / Nguyễn Văn A", companyPh: "株式会社〇〇",
    servicePh: "選択してください / Chọn dịch vụ",
    services: [{ v: "hr", l: "人材紹介 / Giới thiệu nhân sự" }, { v: "nenkin", l: "年金・社会保険 / Nenkin" }, { v: "visa", l: "観光ビザ / Visa du lịch" }, { v: "zairyu", l: "在留手続き / Thủ tục lưu trú" }, { v: "other", l: "その他 / Khác" }],
    messagePh: "ご質問・ご要望をご記入ください / Nhập nội dung...",
    submit: "送信する · Gửi liên hệ →", sending: "送信中...",
    privacy: "個人情報は適切に管理し、第三者に提供しません。\nThông tin của bạn được bảo mật hoàn toàn.",
    successTitle: "送信完了", successBody: "お問い合わせありがとうございます。\n24時間以内にご連絡いたします。",
    successSub: "Chúng tôi sẽ liên hệ trong vòng 24 giờ.",
    anotherBtn: "別のお問い合わせ",
  },
  EN: {
    eyebrow: "Contact Us",
