...
const ROWS = {
  ...
  EN: [
    ...
    { label: "CEO",            value: "Nguyen Thi Lan Tari" },
    ...
    { label: "Employees",      value: "14 (incl. directors & part-time)" },
    ...
    { label: "Main Banks", span: true, value: "SMBC Shinjuku Iwato Branch / Matsuyama Shinkin Bank Main Branch" },
  ] as Row[],
  VN: [
    { label: "Tên công ty",    value: "Công ty Cổ phần ASEKA" },
    { label: "Thành lập",      value: "Tháng 5 năm 2021" },
    { label: "Giám đốc",       value: "Nguyễn Thị Lan Tari" },
    ...
    { label: "Nhân viên",      value: "14 người (bao gồm giám đốc và bán thời gian)" },
    ...
    { label: "Ngân hàng giao dịch", span: true, value: "SMBC Chi nhánh Shinjuku Iwato / Ngân hàng Tín dụng Matsuyama Chi nhánh chính" },
  ] as Row[],
};
